...
*   **Ghostscript (Optional but Recommended for PDF Loading):** For the "Load from PDF" feature to work reliably with a wider range of PDF files (especially those with complex table structures not generated by this application), having Ghostscript installed and accessible in your system's PATH is beneficial.
    *   If you encounter issues loading data from certain PDFs, installing Ghostscript may resolve them.
